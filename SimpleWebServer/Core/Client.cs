...
namespace SimpleWebServer.Core
{
    public class Client
    {
        ...
        public Client(TcpClient client)
        {
            ...
            if(Program.IsDebugEnabled) Console.WriteLine($"Connection accepted");
        ...
        private void ParseRequest()
        {
            ...
            if(Program.IsDebugEnabled) Console.WriteLine("{0} requested: {1}", _currentTcpClient.Client.RemoteEndPoint, RequestUrl);
            ...
            if(Program.IsDebugEnabled) Console.WriteLine($"Requested File: {RequestedFilePath}");
            FileWork();
        }
